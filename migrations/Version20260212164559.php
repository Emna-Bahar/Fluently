 ...
 */
final class Version20260212164559 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE test_passage DROP niveau_attribue');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE test_passage ADD niveau_attribue VARCHAR(10) DEFAULT NULL');
    }
}
