 ...
 */
final class Version20260301195655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, numero INT NOT NULL, ressource LONGTEXT DEFAULT NULL, date_creation DATE NOT NULL, cours_precedent_id_id INT DEFAULT NULL, id_niveau_id INT NOT NULL, UNIQUE INDEX UNIQ_FDCA8C9CC603F320 (cours_precedent_id_id), INDEX IDX_FDCA8C9C8B0B20A6 (id_niveau_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE langue (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, drapeau VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, description VARCHAR(255) NOT NULL, popularite VARCHAR(50) DEFAULT NULL, date_ajout DATE NOT NULL, is_active TINYINT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, date_heure DATETIME NOT NULL, statut VARCHAR(50) NOT NULL, lien_reunion VARCHAR(255) DEFAULT NULL, id_group_id INT DEFAULT NULL, id_user_id INT DEFAULT NULL, INDEX IDX_D044D5D4AE8F35D2 (id_group_id), INDEX IDX_D044D5D479F37AE5 (id_user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE test (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, type VARCHAR(50) NOT NULL, duree_estimee INT DEFAULT NULL, langue_id INT NOT NULL, niveau_id INT DEFAULT NULL, INDEX IDX_D87F7E0C2AADBACD (langue_id), INDEX IDX_D87F7E0CB3E9C81 (niveau_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(100) NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, statut VARCHAR(100) NOT NULL, face_descriptor LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
