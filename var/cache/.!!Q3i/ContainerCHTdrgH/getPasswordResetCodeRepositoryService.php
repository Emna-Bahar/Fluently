 ...
 */
class getPasswordResetCodeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PasswordResetCodeRepository' shared autowired service.
     *
     * @return \App\Repository\PasswordResetCodeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PasswordResetCodeRepository.php';

        return $container->privates['App\\Repository\\PasswordResetCodeRepository'] = new \App\Repository\PasswordResetCodeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
