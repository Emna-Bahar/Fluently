...
class getRegisterControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.KcgWl0N'] ?? $container->load('get_ServiceLocator_KcgWl0NService'))->withContext('App\\Controller\\RegisterController', $container));
