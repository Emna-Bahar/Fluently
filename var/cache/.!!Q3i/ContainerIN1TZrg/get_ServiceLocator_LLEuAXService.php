...
class get_ServiceLocator_LLEuAXService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.LLEuAX_'])) {
            return $container->privates['.service_locator.LLEuAX_'];
        }

        return $container->privates['.service_locator.LLEuAX_'] = $instance;
    }
}
