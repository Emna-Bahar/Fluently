 ...
 */
class getTestPassageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TestPassageRepository' shared autowired service.
     *
     * @return \App\Repository\TestPassageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TestPassageRepository.php';

        return $container->privates['App\\Repository\\TestPassageRepository'] = new \App\Repository\TestPassageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
