...
class getDashboardControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.f6cOPhg'] ?? $container->load('get_ServiceLocator_F6cOPhgService'))->withContext('App\\Controller\\DashboardController', $container));
