 ...
 */
class getMessageLogRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MessageLogRepository' shared autowired service.
     *
     * @return \App\Repository\MessageLogRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MessageLogRepository.php';

        return $container->privates['App\\Repository\\MessageLogRepository'] = new \App\Repository\MessageLogRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
