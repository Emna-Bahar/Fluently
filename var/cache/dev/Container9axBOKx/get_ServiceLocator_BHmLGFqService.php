...
class get_ServiceLocator_BHmLGFqService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.BHmLGFq'])) {
            return $container->privates['.service_locator.BHmLGFq'];
        }

        return $container->privates['.service_locator.BHmLGFq'] = $instance;
    }
}
