...
class getDashboardControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.JjbtCee'] ?? $container->load('get_ServiceLocator_JjbtCeeService'))->withContext('App\\Controller\\DashboardController', $container));
