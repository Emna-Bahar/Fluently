 ...
 */
class getVichUploader_Listener_Clean_LangueDrapeauService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.langue_drapeau' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.langue_drapeau'])) {
            return $container->privates['vich_uploader.listener.clean.langue_drapeau'];
        }

        $instance = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('langue_drapeau', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);

        if (isset($container->privates['vich_uploader.listener.clean.langue_drapeau'])) {
            return $container->privates['vich_uploader.listener.clean.langue_drapeau'];
        }

        return $container->privates['vich_uploader.listener.clean.langue_drapeau'] = $instance;
    }
}
