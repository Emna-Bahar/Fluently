...
class get_ServiceLocator_GBkZnE5Service extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.gBkZnE5'])) {
            return $container->privates['.service_locator.gBkZnE5'];
        }

        return $container->privates['.service_locator.gBkZnE5'] = $instance;
    }
}
