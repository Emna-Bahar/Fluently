...
class getQuestionControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.7kF0UsX'] ?? $container->load('get_ServiceLocator_7kF0UsXService'))->withContext('App\\Controller\\QuestionController', $container));
