...
class getGameControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.7kF0UsX'] ?? $container->load('get_ServiceLocator_7kF0UsXService'))->withContext('App\\Controller\\GameController', $container));
