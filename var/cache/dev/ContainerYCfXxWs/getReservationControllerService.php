...
class getReservationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.yhb3Pxq'] ?? $container->load('get_ServiceLocator_Yhb3PxqService'))->withContext('App\\Controller\\ReservationController', $container));
