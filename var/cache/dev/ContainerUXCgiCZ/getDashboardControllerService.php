...
class getDashboardControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.a_BEVU0'] ?? $container->load('get_ServiceLocator_ABEVU0Service'))->withContext('App\\Controller\\DashboardController', $container));
