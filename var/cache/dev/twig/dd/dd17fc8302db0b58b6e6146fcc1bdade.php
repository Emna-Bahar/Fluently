...
class __TwigTemplate_30a2b669254425448eca6788178e6a27 extends Template
{
        ...
        if ((($tmp = (isset($context["langues"]) || array_key_exists("langues", $context) ? $context["langues"] : (function () { throw new RuntimeError('Variable "langues" does not exist.', 55, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["langue"]) {
                ...
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["langue"], "drapeau", [], "any", false, false, false, 65)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    ...
                    // line 67
                    yield "                                        <img src=\"";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/langues/" . CoreExtension::getAttribute($this->env, $this->source, $context["langue"], "drapeau", [], "any", false, false, false, 67))), "html", null, true);
                    yield "\" 
                                             alt=\"Drapeau ";
                    // line 68
                ...
                // line 77
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["langue"], "nom", [], "any", false, false, false, 77), "html", null, true);
                yield "</h3>
                                    <p style=\"color: #4b5563; margin: 0 0 32px; line-height: 1.6; flex-grow: 1; font-size: 1.15rem;\">
                                        ";
                // line 79
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::slice($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["langue"], "description", [], "any", false, false, false, 79), 0, 140), "html", null, true);
                if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["langue"], "description", [], "any", false, false, false, 79)) > 140)) {
                    yield "...";
                }
                // line 80
                yield "                                    </p>
...
";
    ...
    {
        return array (  252 => 98,  244 => 93,  239 => 90,  235 => 88,  222 => 80,  217 => 79,  212 => 77,  206 => 73,  202 => 71,  196 => 68,  191 => 67,  189 => 66,  187 => 65,  176 => 58,  172 => 57,  169 => 56,  167 => 55,  139 => 32,  133 => 31,  120 => 21,  114 => 18,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}", "langue/index.html.twig", "C:\\Users\\Retr0\\Desktop\\Fuser\\Fuser\\Fluently\\Fluently\\Fluently\\USER_LANGUE_TEST_OBJ\\templates\\langue\\index.html.twig");
    }
}
