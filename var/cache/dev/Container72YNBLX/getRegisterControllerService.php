...
class getRegisterControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.I3rZj3C'] ?? $container->load('get_ServiceLocator_I3rZj3CService'))->withContext('App\\Controller\\RegisterController', $container));
