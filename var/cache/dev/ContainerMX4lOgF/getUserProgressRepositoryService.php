...
{
    /**
     * Gets the private 'App\Repository\UserProgressRepository' shared autowired service.
     *
     * @return \App\Repository\UserProgressRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserProgressRepository.php';

        return $container->privates['App\\Repository\\UserProgressRepository'] = new \App\Repository\UserProgressRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
