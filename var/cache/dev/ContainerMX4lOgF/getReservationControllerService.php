...
class getReservationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.PVp.ASL'] ?? $container->load('get_ServiceLocator_PVp_ASLService'))->withContext('App\\Controller\\ReservationController', $container));
