...
public function new(Request $request, EntityManagerInterface $entityManager): Response
{
    ...
    // Créer le formulaire EN LIANT l'objet Objectif
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        // Si le formulaire est soumis mais invalide, les erreurs seront affichées automatiquement
        // grâce aux contraintes du formulaire
...
public function edit(Request $request, int $id, ObjectifRepository $objectifRepository, EntityManagerInterface $entityManager): Response
{
    ...
    // Créer le formulaire avec l'objet Objectif existant
    $form = $this->createForm(ObjectifType::class, $objectif);
    $form->handleRequest($request);
